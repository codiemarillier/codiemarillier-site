  ...
  return (
    <main className="page-fade">
      <section className="relative overflow-hidden bg-charcoal text-paper">
        ...
        <div className="relative mx-auto max-w-4xl px-5 py-10 md:px-8 md:py-16">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#d8b56b]">Start here from Instagram</p>
      ...
      <section className="mx-auto max-w-5xl px-5 py-10 md:px-8 md:py-16">
        <div className="grid gap-4 sm:grid-cols-2">
          {secondaryLinks.map((item) => {
            ...
            return (
              <Link key={item.href} to={item.href} className="group border border-line bg-paper p-5 transition-colors hover:bg-ivory">
                <span className="flex h-10 w-10 items-center justify-center border border-line bg-ivory text-gold">
                  <Icon className="h-5 w-5" aria-hidden="true" />
                </span>
