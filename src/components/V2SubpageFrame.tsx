  ...
  return (
    <div className="v2-shell v2-detail-shell min-h-screen overflow-x-hidden bg-[#F7F8FA] text-[#0B1F33]">
      ...
      <main ref={mainRef} id="v2-subpage-main" tabIndex={-1}>
        <section className="v2-detail-hero px-5 py-16 text-[#F7F8FA] sm:px-8 sm:py-24 lg:px-12">
          <div className="mx-auto max-w-[1344px]">
            <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#9DBBE8]">{eyebrow}</p>
