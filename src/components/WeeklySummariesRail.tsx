...
const weeklyEntries = journalEntries.filter((entry) => entry.category === 'Weekly Reviews');
    ...
    <section className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
      <div className="mb-10 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <SectionHeader
          ...
          text="Each weekly summary shows what changed, what helped, what hurt, and what I wanted to watch next. This is the main accountability record."
        />
